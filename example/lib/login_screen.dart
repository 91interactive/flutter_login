...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
        ...
        insideHeaderWidget: const InsideHeaderWidget());
  }
}

class InsideHeaderWidget extends StatelessWidget {
  const InsideHeaderWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
      child: const Text("INSIDEHEADER"),
    );
  }
}
